<x-app-layout>
    ...
    <form>
        <div class="p-5">
            <div>
                <div class="mb-3">
                    <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900">Nombre(s)</label>
                ...
                <div class="mb-3">
                    <label for="telefono" class="block mb-2 text-sm font-medium text-gray-900">Phone number</label>
