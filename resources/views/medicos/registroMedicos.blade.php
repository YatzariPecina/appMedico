            ...
            <div class="col-md-12">
                <form action="{{ route('medicos.store') }}" method="POST">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" id="profesion" name="profesion" class="form-control" placeholder="Ingrese su profesion">
                    </div>
                    <div class="form-group mt-3">
                        <label for="tipo_medico" class="block mb-2 text-sm font-medium text-gray-900">Tipo de medico:</label>
                        <input type="text" id="tipo_medico" name="tipo_medico" class="form-control" placeholder="Ingrese el tipo de medico">
                    </div>
